...
# 写入 CSV 表头
echo "Environment,Seed,Noise_Type,Attack_Type,DT_Att,DT_Raw" > "$SUMMARY_FILE"
...
for env_dir in "$BASE_DIR"/*; do
    ...
    for condition_dir in "$env_dir"/*; do
        ...
        remainder="${condition_name#$"DT"_${env}_}"
...
for env_dir in "$BASE_DIR"/*; do
    ...
    for condition_dir in "$env_dir"/*; do
        ...
        # 独立日志文件
        LOG_FILE="${LOG_DIR}/DT_${env}_${ATTACK_MODE}_${location}_seed${SEED}.log"
